...
to setup
  ...
  set maximum-sugar-endowment (minimum-sugar-endowment * (1 + (increase / 100)))
...
@#$#@#$#@
<experiments>
  <experiment name="sugar" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="3000"/>
    <metric>(gini-index-reserve / count turtles) * 2</metric>
    <metric>mean [sugar] of turtles</metric>
    <metric>median [sugar] of turtles</metric>
    <metric>max [sugar] of turtles</metric>
    <metric>mean [age] of turtles</metric>
    <metric>standard-deviation [sugar] of turtles</metric>
    <enumeratedValueSet variable="increase">
      <value value="10"/>
      <value value="50"/>
      <value value="100"/>
    </enumeratedValueSet>
